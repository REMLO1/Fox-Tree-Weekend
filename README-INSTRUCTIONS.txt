...
4. You should land on /thank-you/.
...
FORM FIX ADDED
--------------
The booking form posts to the physical /thank-you/ page.
...
WEEKEND UPDATE
--------------
A new "Find us this weekend" section has been added to the homepage using:
- assets/fox-tree-lindfield-common.webp
- updated index.html
- updated styles-v2.css

Upload the complete contents of this folder to GitHub so all asset paths remain intact.
